...
const Hero = ({titleData, createCampaign}) => {
  ...
  return (
    <div className='relative'>
      ...
      <img 
        src='https://picsum.photos/200/300' //1:48:00
      ...
      <div className='relative bg-opacity-75 backgroundMain'>
        ...
        >
          <path 
            fill='M-164 13L-104 39.7C-44 66 76 120 196 141C316 162 436 152 556 119.7C676
        ...
        <div className='relative px-4 py-16 mx-auto overflow-hidden sm:max-w-xl md:max-x-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20'>
          <div className='flex flex-col items-center justify-between xl:flex-row'>
            <div className='w-full max-w-xl mb-12 xl:mb-0 xl:pr-16 xl:w-7/12'>
              <h2 className='max-w-lg mb-6 font-sans text-3xl font-bold tracking-tight text-white sm:text-5xl sm:leading-none'>
                White Company <br className='hidden md:block' />
                Crowd Funding Platform
              </h2>
              <p className='max-w-xl mb-4 text-base text-gray-200 md:text-lg'>
                Lorem ipsum dolor sit amet consectetur, adipisicing elit. Molestias voluptatibus ullam delectus? Aliquid, illo repudiandae! Lorem ipsum dolor sit amet. Lorem ipsum dolor sit amet consectetur, adipisicing elit. Nobis, accusantium?
              </p>
              <a
                href='/'
                aria-label=''
              ...
              <div className='bg-white rounded shadow-2xl p-7 sm:p-10'>
                ...
                <form>
                  ...
                  <p className='text-xs text-gray-600 sm:text-sm'>
                    Create your Campaign and raise fund
                  </p>
                </form>
              </div>
            </div>
